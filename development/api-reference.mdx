...
Retrieves a note by its display index in the sidebar.

```typescript src/index.ts:166-169
...
<ParamField path="index" type="number" required>
  The display index (0-based) of the note in the sidebar
</ParamField>

<ResponseField name="return" type="UserNote">
  The UserNote object at the specified index, or a new note if the index doesn't exist
</ResponseField>

### setNoteByUUID

Adds or updates a note in the note store by UUID.

```typescript src/index.ts:176-184
...
<ParamField path="uuid" type="string" required>
  The UUID of the note to add or update
</ParamField>

<ParamField path="note" type="UserNote" required>
  The UserNote object to store
</ParamField>

This function handles both adding new notes and updating existing ones. If the UUID is new, it assigns it the next available index.
